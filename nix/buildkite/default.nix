# This work is effectively forked from efforts of the TVL authors
...
let
  ...
  inherit (dev.nix) dependency-analyzer;
in
rec {
  ...
  # this from the root of the repo (assumed to be ./.). Attributes may be any
  ...
  # Attribute path of a target relative to the repo root. Needs to take into
  ...
  # name on Buildkite.
  #
  #   command (required): A command that will be run in the repo
