# Cargo.lock sha256: 53e01239b945df074c59b7ef2134f474b9a744cc931f810aed08cfb8c18f7654
  ...
  internal = rec {
    ...
    crates = {
      ...
      "ego-tree" = rec {
        ...
        version = "0.6.3";
        edition = "2015";
        sha256 = "0hincmpradjn146d4as5yj9c8k5l97wvxfyhf3qzra84mhabp80j";
        libName = "ego_tree";
        authors = [
      ...
      "scraper" = rec {
        ...
        edition = "2021";
        crateBin = [];
        sha256 = "00h8bn3799v0jp3729zyk0kspznwb42ky7fr5qnlh9gnzl2vf7vn";
        authors = [
          "June McEnroe <june@causal.agency>"
        ];
        dependencies = [
