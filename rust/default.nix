...
let
  ...
  inherit (dev.nix.buildRustPackage) buildRustPackage;
  ...
  mergedNativeBuildInputs = unique (
    concatMap (o: o.nativeBuildInputs or [ ]) (builtins.attrValues allOverrides)
  );
